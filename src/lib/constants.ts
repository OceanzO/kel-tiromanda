...
export const ABOUT_DATA = {
  ...
  video_url: 'https://www.youtube.com/embed/h9iQq7CrY4o',
  vision_id: 'Tana Toraja Maju dan Berdaya Saing Berdasarkan Nilai Budaya.',
  vision_en: 'Advanced and Competitive Tana Toraja Based on Cultural Values.',
  mission_id: [
    'Meningkatkan Penyelenggaraan Pemerintahan yang tangkas dan dinamis melalui transformasi digital.',
    'Memperkuat pembangunan sumber daya manusia yang sehat, cerdas, produktif dan berbudaya.',
    'Melanjutkan pembangunan infrastruktur dari desa secara merata.',
    'Memastikan ketersediaan kebutuhan pokok dan biaya hidup murah melalui kemandirian pangan.',
    'Memperluas kesempatan berusaha dan menciptakan lapangan pekerjaan melalui pengembangan ekonomi lokal berbasis pertanian, UMKM, dan pariwisata.',
    'Mewujudkan lingkungan hidup yang berkelanjutan.',
  ],
  mission_en: [
    'Improve agile and dynamic government administration through digital transformation.',
    'Strengthen the development of healthy, smart, productive, and cultured human resources.',
    'Continue equitable infrastructure development starting from the villages.',
    'Ensure the availability of basic needs and low cost of living through food independence.',
    'Expand business opportunities and create jobs through local economic development based on agriculture, MSMEs, and tourism.',
    'Realize a sustainable environment.',
  ],
  area: '5.2 km²',
  population: '3,450',
...
export const CONTACTS = [
  {
    ...
    label_id: 'WhatsApp',
    label_en: 'WhatsApp',
    value: '+62 812-5568-1565',
    url: 'https://wa.me/6281255681565',
    icon: 'FaWhatsapp',
  },
  {
    type: 'phone',
  ...
  },
  {
    ...
    label_id: 'Email',
    label_en: 'Email',
    value: 'kkn116tiromanda@gmail.com',
    url: 'mailto:kkn116tiromanda@gmail.com',
    icon: 'FaEnvelope',
  },
  {
    type: 'instagram',
    label_id: 'Instagram',
    label_en: 'Instagram',
    value: '@kkn116_tiromanda',
    url: 'https://www.instagram.com/kkn116_tiromanda?igsh=aDE1bnE2djl2dW1o',
    icon: 'FaInstagram',
  },
  {
    type: 'tiktok',
    ...
    label_en: 'TikTok',
    value: '@kkn116_tiromanda',
    url: 'https://www.tiktok.com/@kkn116_tiromanda?_r=1&_t=ZS-98bZ44UP8Fk',
    icon: 'FaTiktok',
  },
  {
    type: 'youtube',
    label_id: 'YouTube',
    label_en: 'YouTube',
    value: 'KKN 116 Tiromanda',
    url: 'https://www.youtube.com/channel/UCn4xjuX5YLykOP_xaMA2U9g',
    icon: 'FaYoutube',
  },
];
